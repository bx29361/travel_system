...
public class DemoApplication {
	...
	public static void main(String[] args) {
		...
		Customers customers = new Customers(2,"arta","gashi","1234567891235",123.25);
		System.out.println(customers.toString());


		try {
			customers.ndrim("agon");
		...
		try{
			...
			System.out.println("The number should contain 389 at the beggining!");
		}
		...
		Employees employees=new Employees(1,"Bejtyl","Xhemail","123456",21);
		try{
